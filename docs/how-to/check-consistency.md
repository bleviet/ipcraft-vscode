...
Consistency checking finds drift: a difference between the IP core description
and the HDL or vendor files that are meant to match it.
...
| Severity | Meaning |
| --- | --- |
| Amber | A difference that can usually be added safely, such as a new HDL port not yet in the specification |
| Red | A conflict that needs a decision, such as a missing port or different width |
