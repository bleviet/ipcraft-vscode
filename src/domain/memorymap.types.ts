...
/**
 * Field name in the same register to watch for change-of-state. Valid only on write-1-to-clear fields. Generator creates an internal shadow register and comparator — no external pulse port is emitted for this field.
 */
export type Monitorchangeof = string | null;
/**
 * Bit fields
 */
 ...
 */
export type MemoryMap = MemoryMap1[];
...
export interface BitFieldDef {
  ...
  monitorChangeOf?: Monitorchangeof;
  [k: string]: unknown;
}
