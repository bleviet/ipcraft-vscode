...
export interface TableContextMenuProps {
  ...
  /** Omit to hide the "Insert Above" button (insert is handled by the hover bar instead). */
  onInsertAbove?: () => void;
  /** Omit to hide the "Insert Below" button (insert is handled by the hover bar instead). */
  onInsertBelow?: () => void;
  onDelete: () => void;
  onClose: () => void;
}
